            ...
            <div>
                ...
                <Container className="pre-test-info">
                    <div className="info-box">
                        ...
                        <p>Attention! The main objective of the course is to learn, not pass the test. Even that there is
                        possibility to take the certification test without going through course content previously, we strongly
                        advise you not to do so. You should be able to answer the questions based on your knowledge, not the luck. 
                        ...
                        <p>This test is made up of <strong>10</strong> multiple-choice- and true/false questions. To get a certificate you must have at least <strong>80 %</strong> of the test correct.
                        </p>
